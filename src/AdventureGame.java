...
public class AdventureGame {
    ...
    private Map<Compass, String> loadDirections(String nextPlaces) {
        ...
        for (String nextPlace : nextSteps) {
            ...
            Compass compass = Compass.valueOf(splits[0]);
    ...
    public void move(String direction) {
        ...
        Map<Compass, String> nextPlaces = adventureMap.get(lastPlace).nextPlaces;
        String nextPlace = nextPlaces.get(Compass.valueOf(direction));
